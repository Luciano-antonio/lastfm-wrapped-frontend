...
function Dashboard()    {
    ...
    return (
        <div className="min-h-screen bg-[#0a0a0a]">    
            ...
            <section onClick={() => navigate('/top-tracks')} className="... cursor-pointer mb-12" >
                ...
                <div className="flex gap-4 overflow-visible">
                    {tracks.slice(0, 5).map((track: any) => (
                        <div key={track.imagem} className="relative group cursor-pointer hover:scale-110 transition-transform duration-200">
                            ...
                            <div className="absolute buttom-0 left-0 right-0 bg-black/70 rounded-b-lg p-1 opacity-0 group-hover:opacity-100 transition-opacity">
            ...
            <section onClick={() => navigate('/top-artists')} className="... cursor-pointer mb-12" >
            ...
            <section onClick={() => navigate('/recently-played')} className="... cursor-pointer mb-12">
